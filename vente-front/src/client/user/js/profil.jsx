...
export default function Profil({ }) {
    ...
    useEffect(() => {
        axios.get('http://localhost:8080/client/clients/'+ `${idClient}`).then(function (response){
            ...
            <div id='profil-body'>
                <div id='profil-left'>
                    ...
                    <div id='profil-logout'>
                        <div id='nav-button' style={{ borderBottom: '2p x solid rgb (238, 238, 238)' }} onClick={handleLogout}>
