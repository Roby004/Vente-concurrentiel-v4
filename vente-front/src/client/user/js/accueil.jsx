...
export default function Accueil({ }) {
    ...
    const idCli = localStorage.getItem('idClient')
    useEffect(() => {
    ...
    const imgClient = client.map(item => {
    ...
    return (
        <>
            <div id='body-accueil'>
                ...
                <div id="right-accueil" >
                    <div id='right-header'>
                        ...
                        <div id="right-entete">
                            ...
                            <div id='right-btn'>
                                <IconButton aria-label="cart" sx={{ height: '60%', p: 1 }} onClick={() => setBoxPanier(true)}>
                                ...
                                <Link to={{
                                    ...
                                    <Avatar src={`data:image/png;base64,${client.imgCli}`} />
                                    </IconButton>
                                </Link>
                ...
                />}
                <Facture data={panierData} client={client} />
            ...
            {/* {loader && <Facture data={panierData} client={client} />} */}
        </>
    )
}